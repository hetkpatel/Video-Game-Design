...
namespace Reading_Text_Files
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            ReadFileAsString(@"Content/anything.txt");
            ReadFileAsInteger(@"Content/numbers.txt");
        }
        ...
        private void DrawText()
        {
            ...
            {
                spriteBatch.DrawString(sf, s, position, Color.Black);
                position.Y += 30;
            }
        }
        ...
        {
            Vector2 position = new Vector2(50, 110);
            int sum = inputX + inputY;
            string answer = "I read " + inputX + " and " + inputY + ". The sum is " + sum;
            spriteBatch.DrawString(sf, answer, position, Color.Black);
        }
    }
}
